...
Relevance
This matters as we can find out the root cause of the churn happening within the business and take necessary steps to 
retain the customers.

Success metric
Build a model to predict if churn is Yes or No for each customer.
